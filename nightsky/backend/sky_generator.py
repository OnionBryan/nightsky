...
# Cached Skyfield ephemeris (loaded once, reused across requests)
_ephemeris = None
_timescale = None
...
def _get_ephemeris():
    ...
    if _ephemeris is None:
        ...
        _ephemeris = load(str(Path(__file__).parent / 'de421.bsp'))
...
def get_moon_info(
    ...
    try:
        ...
        # Illumination percentage (cosine law)
        illumination = (1 - math.cos(math.radians(phase_degrees))) / 2 * 100
